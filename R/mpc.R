...
#'
#' The truncated random normal variables were generated by \code{\link{altrtruncnorm}}. Refer \code{\link{SeasModstoch}}, \code{\link{SeasModdet}}, and \code{\link{Multstoch}} for relative information.
#'dde
...
mpc <- function(pHSinit=c(0.2,0.5,0.8), Kx = 100, betax=c(0.02,0.04), wxtnormm=c(0.3,0.7),
...
temp <- Multstoch(tpHSinit, tKx, tbetax, twxtnormm, twxtnormsd, thx, tmxtnormm, tmxtnormsd, taxtnormm, taxtnormsd, trx, tzxtnormm, tzxtnormsd, tgx, tcx, tphix, tnseasons, tnsim, tHPcut, tpHScut, tmaY, tmiY,  tthetax,  tEx)$outfsum
